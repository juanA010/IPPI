...
public class ParentsMapActivity extends AppCompatActivity implements OnMapReadyCallback{

    LinearLayout SearchSitter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_parents_map);
...
//        getSupportActionBar().setTitle("Map Location Activity");
        ...
        SearchSitter = findViewById(R.id.SearchBabysitter);
        SearchSitter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ParentsMapActivity.this, SearchbabysitterActivity.class));
            }
        });
    }
    ...
    LocationCallback mLocationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                //DatabaseReference SitterLocation = FirebaseDatabase.getInstance().getReference("BabysitterLocation").child("001");

//                SitterLocation.addValueEventListener(new ValueEventListener() {
//                    @Override
//                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
//                        if(dataSnapshot.exists()){
//                            final double getSitterLat = (double) dataSnapshot.child("latitude").getValue();
//                            final double getSitterLong = (double) dataSnapshot.child("longitude").getValue();
//
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                ActivityCompat.requestPermissions(ParentsMapActivity.this,
